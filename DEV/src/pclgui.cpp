#include "pclgui.h"
#include "../build/ui_pclgui.h"

PCLGUI::PCLGUI (QWidget *parent) :
  QMainWindow (parent),
  ui (new Ui::PCLGUI)
{
  ui->setupUi (this);
  this->setWindowTitle ("PCL GUI");
...
void
PCLGUI::pSliderValueChanged (int value)
{
...
void
PCLGUI::redSliderValueChanged (int value)
{
  red = value;
...
void
PCLGUI::greenSliderValueChanged (int value)
{
  green = value;
...
void
PCLGUI::blueSliderValueChanged (int value)
{
  blue = value;
