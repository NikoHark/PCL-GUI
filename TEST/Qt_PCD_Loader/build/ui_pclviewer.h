...
public:
    ...
    void retranslateUi(QMainWindow *PCLViewer)
    {
        ...
        pushButton_loadPCD->setText(QApplication::translate("PCLViewer", "Load PCD File", 0));
    } // retranslateUi
